...
.. note::
   ...
   Each board includes optional exercises you can complete if you finish early.
   After you finish the exercises, before the board swap, make sure to poweroff
   the carrier boards (CoraZ7s, Jupiter SDR, Raspberry Pi 4).
...
:dokuwiki:`ADI Kuiper Linux Wiki <resources/tools-software/linux-software/adi-kuiper-linux>`

:git-adi-kuiper-gen:`adi-kuiper-gen Repository </>`

*Specific hardware resources*

:adi:`CoraZ7s Product Page <en/resources/evaluation-hardware-and-software/evaluation-boards-kits/cora-z7s.html>`

:adi:`Jupiter SDR Product Page <en/resources/evaluation-hardware-and-software/evaluation-boards-kits/jupiter.html>`

:adi:`EVAL-ADXL355-PMDZ Product Page <EVAL-ADXL355-PMDZ>`

*Linux Software Drivers*

:ez:`Linux Software Drivers - EngineerZone <linux-software-drivers>`
